...
def pgf_direction_plotter(direction: list, path: str, degree=None) -> None:
    """
    ...
    for k, file in enumerate(file_list):
        ...
        for i in range(np.shape(press_data)[0]):
            ...
            for j in heights:
                ...
                bearing = np.degrees(np.arctan(dpress_dy / dpress_dx))  # Calculates PGF initial bearing
    ...
    plt.title('Average PGF Direction vs Time')
    plt.ylabel(r'Direction ($\degree$)')
    plt.xlabel('Time (UTC)')
    plt.legend(loc='upper right')
    plt.savefig('/rstor/jmayhall/aes551_project/degree_plots/pgf_degree_scatter.jpg')
    plt.close('all')
    ...
    plt.ylabel(r'Direction ($\degree$)')
    plt.xlabel('Time (UTC)')
    plt.savefig('/rstor/jmayhall/aes551_project/degree_plots/pgf_985_degree.jpg')
    plt.close('all')
    ...
    plt.ylabel(r'Direction ($\degree$)')
    plt.xlabel('Time (UTC)')
    plt.savefig('/rstor/jmayhall/aes551_project/degree_plots/pgf_895_degree.jpg')
    plt.close('all')
    ...
    plt.ylabel(r'Direction ($\degree$)')
    plt.xlabel('Time (UTC)')
    plt.savefig('/rstor/jmayhall/aes551_project/degree_plots/pgf_800_degree.jpg')
    plt.close('all')
    ...
    plt.ylabel(r'Direction ($\degree$)')
    plt.xlabel('Time (UTC)')
    plt.savefig('/rstor/jmayhall/aes551_project/degree_plots/pgf_700_degree.jpg')
    plt.close('all')
    ...
    plt.ylabel(r'Direction ($\degree$)')
    plt.xlabel('Time (UTC)')
    plt.savefig('/rstor/jmayhall/aes551_project/degree_plots/pgf_600_degree.jpg')
    plt.close('all')
    ...
    plt.ylabel(r'Direction ($\degree$)')
    plt.xlabel('Time (UTC)')
    plt.savefig('/rstor/jmayhall/aes551_project/degree_plots/pgf_487_degree.jpg')
    plt.close('all')
    ...
    plt.ylabel(r'Direction ($\degree$)')
    plt.xlabel('Time (UTC)')
    plt.savefig('/rstor/jmayhall/aes551_project/degree_plots/pgf_412_degree.jpg')
    plt.close('all')
    ...
    plt.ylabel(r'Direction ($\degree$)')
    plt.xlabel('Time (UTC)')
    plt.savefig('/rstor/jmayhall/aes551_project/degree_plots/pgf_288_degree.jpg')
    plt.close('all')
    ...
    plt.xlabel('Time (UTC)')
    plt.legend(loc='upper right')
    plt.savefig('/rstor/jmayhall/aes551_project/degree_plots/pgf_total_degree.jpg')


if __name__ == '__main__':
    pgf_direction_plotter(direction=[41, 37, -102, -109],
